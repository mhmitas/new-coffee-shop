    ...
    return (
        <div>
            <header className="hero h-[500px] mb-16" style={{ backgroundImage: `url(${coffee_banner})` }}>
                <div className="hero h-[500px] bg-slate-950 bg-opacity-20"></div>
                <div className="hero-content text-center text-neutral-content">
                    <div className="max-w-md">
                        <h1 className="mb-5 text-3xl font-extrabold rancho-regular ">Would you like a Cup of Delicious Coffee?</h1>
